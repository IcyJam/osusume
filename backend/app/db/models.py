...
media_content_descriptors = Table(
    ...
    Column("content_descriptor_id", Integer,ForeignKey("content_descriptors.content_descriptor_id", ondelete="CASCADE"),primary_key=True),
)
...
class ContentDescriptor(Base):
    ...
    media = relationship("Media", secondary=media_content_descriptors, back_populates="content_descriptors")
